...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <table id="datatableUsuariosMR" class="table table-bordered table-hover dt-responsive datatableUsuariosMR">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="" role="form" id="formEdtUs" method="post">
                <div class="modal-header text-center bg-olive" style="background: #5D646C; color: white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <i class="fas fa-user"></i> *
                                <div class="input-group">
                                    <input type="text" name="edtUsuario" id="edtUsuario" class="form-control" required autocomplete="off" autofocus="autofocus" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-12 col-lg-4">
