...
class ImprimirKardexEmpleado
{
    public $idEmpleado;
    public $anio;
    public function imprimirFichaKardex()
    {
        ...
        $fichIntE3 = ReportesControlador::ctrDatosPersonalKardexDiasDisp($idEmpleado, $anio);
        ...
        if ($fichIntE3["diasAcumulados"] != null) {
            $diasAcum = $fichIntE3["diasAcumulados"];

            $diferencia = 20 - $fichIntE3["diasAcumulados"];

            if ($diferencia >= 0) {
                $disponibles = $diferencia;
            }
            else {
                $disponibles = 0;
            }
        ...
        foreach ($fichIntEC2 as $key => $item) {
            ...
            $medico = substr($item["nombresMed"], 0, 20);
            ...
            <<<EOF
                <table cellpadding="2" cellspacing="1.2" class="block-1" style="text-align:center;">
                    <tr>
                        ...
                        <td style="width:40px;background-color:white;"><p style="text-align: right;">$diasAcum</p></td>
                        <td style="width:95px;background-color:white;"><p style="text-align: left;"><b>DISPONIBLES: </b></p></td>
                        <td style="width:40px;background-color:white;"><p style="text-align: right;">$disponibles</p></td>
                    </tr>
                </table>
            EOF;
...
$fichaImprimir->imprimirFichaKardex();
