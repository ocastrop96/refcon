...
class ImprimirConsolidadoControlMaternidad
{
    ...
    public function imprimirFichaConsolidadoMat()
    {
        ...
        $detalleLicenciasMat = ReportesControlador::ctrControlMaternidad($anio);
        ...
        $pdf->SetTitle('Consolidado Maternidad ' . '- ' . $anio);
        ...
        $pdf->AddPage('L', 'A4');
        // -----------------------------------------------------------------------------
        $htmlhead = '<h1 style="text-align:center;">RELACION DE LICENCIAS POR MATERNIDAD DEL AÑO - ' . $anio . ' <br>DE LA COORDINACION DEL EQUIPO DE GESTION DEL DESARROLLO Y RH</h1>';
        ...
        $tbl = <<<EOD
                ...
                <tr>
                    ...
                    <td style="text-align:left; width:330px;background-color:white;
                    border-bottom: 1px solid #000000;
        ...
        // Inicia detalle de licencias
            foreach ($detalleLicenciasMat as $key => $item) {
                ...
                <tr>
                    ...
                    <td style="text-align:left; width:330px;background-color:white;border-bottom: 1px solid #505050;"> $empleadoN</td>
                    <td style="text-align:center; width:100px;background-color:white;border-bottom: 1px solid #505050;">$item[descCondicion]</td>
                    <td style="text-align:center;vertical-align: middle; width:80px;background-color:white;border-bottom: 1px solid #505050;">$item[descMes]</td>
                    <td style="text-align:center; width:65px;background-color:white;border-bottom: 1px solid #505050;">$item[fechaIngreso]</td> 
