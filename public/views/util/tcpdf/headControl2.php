...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $htmlhead = '<p style="text-align: center;">DECENIO DE LA IGUALDAD DE OPORTUNIDADES PARA MUJERES Y HOMBRES<br>"Año del Bicentenario del Perú: 200 años de independencia"<p>';
